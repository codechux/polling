...
CREATE INDEX IF NOT EXISTS idx_polls_creator_id_created_at 
ON polls(creator_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_polls_creator_id_is_active 
ON polls(creator_id, is_active);

-- Add comments for documentation
COMMENT ON INDEX idx_polls_creator_id_created_at IS 'Optimizes getUserPolls query';
...
COMMENT ON INDEX idx_polls_creator_id_is_active IS 'Optimizes user poll filtering queries';